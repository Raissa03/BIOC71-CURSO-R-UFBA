...
## Nao consegui da um push pois o criador do repositorio não premitiu que eu fizesse alteracoes.

#O que é um pull request?
##é um comando que atualiza as modificacoes do github na maquina.

#O que é um fork?
#### é Quando se "baixa" os arquivos do github de uma outra pessoa em sua maquina ( o que possibilita realizar alteracoes). Depois e possivel reenviar a pessoa com as alteracoes e cabe a ela aceitar ou nao####
...
## É possivel restaurar verificando a versao anterior que pode ser visualizado no history, verificando isso podemos fazer as alteracoes e modificar o arquivo onde desejarmos
